...
export const fetchPageSpeedData = async (url) => {
    ...
    const results = {
        mobile: { error: 'API key not configured', status: 'error', performance_score: null, accessibility_score: null, seo_score: null, metrics: {} },
        desktop: { error: 'API key not configured', status: 'error', performance_score: null, accessibility_score: null, seo_score: null, metrics: {} }
    };
