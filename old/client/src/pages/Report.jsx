...
const AppModals = ({
  showKeywordsModal,
  setShowKeywordsModal,
  keywordsData,
  showHeadingsModal,
  setShowHeadingsModal,
  headingsData,
  showBrokenLinksModal,
  setShowBrokenLinksModal,
  brokenLinksData,
  showFixedWidthElementsModal,
  setShowFixedWidthElementsModal,
  fixedWidthElementsData,
  showResponsivenessIssuesModal,
  setShowResponsivenessIssuesModal,
  responsivenessIssuesData,
}) => {
  ...
  useEffect(() => {
    ...
    if (root) {
      ...
      console.error(
        "❌ Error: #modal-root NOT found in the DOM. Please ensure it is present in your index.html."
      );
    }
  }, []);
    ...
    <>
      ...
      {showKeywordsModal &&
        ...
        ReactDOM.createPortal(
          <div
            className={`fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-[100] p-4 ${modalTransitionClasses} ${
              showKeywordsModal ? modalActiveClasses : modalInactiveClasses
            }`}
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {keywordsData.top_keywords.map((kw, index) => (
                      ...
                      >
                        <td className="px-4 py-3 whitespace-nowrap text-base font-medium text-gray-900 dark:text-gray-100">
                          {kw.keyword}
                        </td>
                        <td className="px-4 py-3 whitespace-nowrap text-base text-gray-700 dark:text-gray-200">
                          {kw.frequency}
                        </td>
                        <td className="px-4 py-3 whitespace-nowrap text-base text-gray-700 dark:text-gray-200">
                          {kw.density}%
      ...
      {showHeadingsModal &&
        ...
        ReactDOM.createPortal(
          <div
            className={`fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-[100] p-4 ${modalTransitionClasses} ${
              showHeadingsModal ? modalActiveClasses : modalInactiveClasses
            }`}
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {headingsData.map((h, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 whitespace-normal text-base text-gray-700 dark:text-gray-200">
                          {h.text}
                        </td>
                      </tr>
                    ))}
      ...
      {showBrokenLinksModal &&
        ...
        ReactDOM.createPortal(
          <div
            className={`fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-[100] p-4 ${modalTransitionClasses} ${
              showBrokenLinksModal ? modalActiveClasses : modalInactiveClasses
            }`}
          ...
          >
            ...
            >
              ...
              {brokenLinksData.length > 0 ? (
                  ...
                  <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead className="bg-gradient-to-r from-red-500 to-rose-600 text-white">
                      <tr>
                        ...
                        <th className="px-4 py-3 text-left text-sm font-semibold uppercase tracking-wider rounded-tr-lg">
                          Status
                        </th>
                      </tr>
                    </thead>
                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                      {brokenLinksData.map((link, index) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 whitespace-normal text-sm text-red-700 dark:text-red-300">
                            {link.reason}
                          </td>
                        </tr>
                      ))}
                ...
                <p className="text-green-600 dark:text-green-300 text-center text-xl py-8">
          ...
          >
            ...
            >
              ...
              {fixedWidthElementsData.length > 0 ? (
                ...
                <p className="text-green-600 dark:text-green-300 text-center text-xl py-8">
                  No fixed-width elements found. Great job!
                </p>
              )}
            </div>
          </div>,
          ...
          >
            ...
            >
              ...
              {responsivenessIssuesData.length > 0 ? (
                ...
                <p className="text-green-600 dark:text-green-300 text-center text-xl py-8">
                  No specific responsiveness issues found.
                </p>
              )}
            </div>
          </div>,
...
const Report = () => {
  ...
  // Modal states and handlers (unchanged from previous version)
  ...
  const [showFixedWidthElementsModal, setShowFixedWidthElementsModal] =
    useState(false);
  const [fixedWidthElementsModalData, setFixedWidthElementsModalData] =
    useState(null);
  const [showResponsivenessIssuesModal, setShowResponsivenessIssuesModal] =
    useState(false);
  const [responsivenessIssuesModalData, setResponsivenessIssuesModalData] =
    useState(null);
  ...
  useEffect(() => {
    if (!websiteUrl) {
      setError(
        "No website URL provided. Please go back to the homepage and enter a URL."
      );
      setLoading(false);
      return;
    }
    ...
    const fetchReport = async () => {
      try {
        ...
        const response = await fetch(
          "https://seo-report-11.onrender.com/api/generate-report",
          {
            method: "POST",
        ...
        const getReadabilityStatus = (score) => {
          ...
          if (score >= 50)
            return { text: "Fairly Difficult", status: "warning" };
        ...
        const getMobileResponsivenessExplanation = (auditData) => {
          ...
          if (!has_viewport_meta) {
            explanationText +=
              "Missing viewport meta tag. This is crucial for proper scaling on mobile devices. ";
          } else if (
            !viewport_content ||
            !viewport_content.includes("width=device-width")
          ) {
            explanationText += `Viewport meta tag found but is not correctly configured (content: "${
              viewport_content || "N/A"
            }"). Ensure "width=device-width" is present. `;
          } else {
        ...
        // Title Optimization
        let titleStatus =
          metadataLengthAudit.title?.status.toLowerCase() || "bad";
        let titleExplanation =
          metadataLengthAudit.title?.recommendation ||
          "Title tag analysis failed.";
        ...
        // Meta Description
        let metaDescriptionStatus =
          metadataLengthAudit.meta_description?.status.toLowerCase() || "bad";
        let metaDescriptionExplanation =
          metadataLengthAudit.meta_description?.recommendation ||
          "Meta description analysis failed.";
        groupedSections.Content.push({
          id: "meta-description",
        ...
        if (
          h1Count === 0 ||
          headingIssues.some((issue) => issue.startsWith("❌"))
        ) {
          headingStatus = "bad";
        } else if (
          h1Count > 1 ||
          headingIssues.some((issue) => issue.startsWith("⚠️"))
        ) {
        ...
        groupedSections.Content.push({
          ...
          explanation:
            h1Count === 0
              ? "Missing H1 tag. This is crucial for content hierarchy and SEO."
              : h1Count === 1 && headingIssues.length === 0
              ? "Heading structure looks good!"
              : "Potential issues found in heading structure. See details below.",
          headingCounts: {
            h1_count: h1Count,
            h2_count: h2Count,
            h3_count: h3Count,
        ...
        const readabilityInfo = getReadabilityStatus(
          contentAnalysis.flesch_reading_ease_score
        );
        ...
        if (
          ...
          contentAnalysis.keyword_suggestions &&
          contentAnalysis.keyword_suggestions.some(
            (s) => s.startsWith("❌") || s.startsWith("⚠️")
          )
        ) {
          if (contentAnalysisStatus === "good")
            contentAnalysisStatus = "warning";
        }
        groupedSections.Content.push({
          id: "content-analysis",
        ...
        const imageStatus =
          total === 0 ? "good" : withAlt === total ? "good" : "warning";
        ...
        const speedAuditStatus =
          speedAudit.issues && speedAudit.issues.length === 0
            ? "good"
            : "warning";
        groupedSections.Technical.push({
          id: "speed-heuristics",
        ...
        const linkAuditStatus =
          linkAudit.broken_links_count === 0 ? "good" : "bad";
        groupedSections.Technical.push({
          id: "link-audit",
          title: "Link Profile",
        ...
        if (
          structuredDataAudit.ld_json_found &&
          structuredDataAudit.schema_types.length > 0 &&
          structuredDataAudit.issues.length === 0
        ) {
          ...
          structuredDataExplanation =
            "No structured data schema found. Consider adding JSON-LD for rich snippets.";
        }
        groupedSections.Technical.push({
        ...
        let localSeoStatus = localSeoAudit.status
          .toLowerCase()
          .includes("present")
          ? "good"
          : localSeoAudit.status.toLowerCase().includes("partial")
          ? "warning"
          : "bad";
        ...
        if (localSeoAudit.status === "✅ Present") {
          localSeoExplanation =
            "Key local SEO elements (schema, address, phone) are present.";
        } else if (localSeoAudit.status === "⚠️ Partial") {
          localSeoExplanation =
            "Local SEO implementation is partial. Review details for improvements.";
        } else {
          localSeoExplanation =
            "Local SEO essentials are missing. Consider implementing schema, physical address, and phone number.";
        }

        groupedSections.Technical.push({
          // Adding to Technical group
          id: "local-seo-audit",
          title: "Local SEO",
        ...
        const mobileResponsivenessStatus = getMobileResponsivenessDisplayStatus(
          mobileResponsivenessAudit
        );
        const mobileResponsivenessExplanation =
          getMobileResponsivenessExplanation(mobileResponsivenessAudit);
        ...
        if (
          ogTwitterAudit.og_title_found &&
          ogTwitterAudit.og_image_found &&
          ogTwitterAudit.og_image_url &&
          ogTwitterAudit.og_image_url.trim() !== ""
        ) {
          socialMetaStatus = "good";
        } else if (
          ogTwitterAudit.og_title_found ||
          ogTwitterAudit.og_image_found ||
          ogTwitterAudit.twitter_title_found ||
          ogTwitterAudit.twitter_image_found
        ) {
        ...
        const goodCount = allSections.filter(
          (section) => section.status === "good"
        ).length;
        const calculatedOverallScore = Math.round(
          (goodCount / (allSections.length || 1)) * 100
        ...
        setError(
          err.message || "Something went wrong while fetching the report."
        );
      } finally {
        setLoading(false);
      }
  ...
  if (loading) {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-purple-100 text-gray-800 dark:from-gray-900 dark:to-gray-800 dark:text-gray-100 transition-colors duration-500 relative overflow-hidden">
            ...
            <div className="md:col-span-2 lg:col-span-1 space-y-3 p-4">
              {categoryBreakdownData.map((category) => (
                ...
                >
                  ...
                  ></span>
                  <span className="flex-grow text-sm font-medium text-gray-700 dark:text-gray-300">
                    {category.name}
                  </span>
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <div className="flex-grow flex justify-center sm:justify-start">
              <nav className="flex space-x-2 sm:space-x-4 bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
                {tabNames.map((tab) => {
                  const counts = getTabStatusCounts(
                    groupedSections?.[tab] || []
                  );
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {groupedSections?.[activeTab]?.map((section) => (
            <ReportCard
              ...
              contentAnalysisData={
                section.id === "content-analysis"
                  ? backendData.content_analysis
                  : null
              }
              onOpenHeadingsModal={
                section.id === "heading-structure"
                  ? handleOpenHeadingsModal
                  : null
              }
              headingCounts={
                section.id === "heading-structure"
                  ? section.headingCounts
                  : null
              }
              headingOrder={
                section.id === "heading-structure" ? section.headingOrder : null
              }
              headingIssues={
                section.id === "heading-structure"
                  ? section.headingIssues
                  : null
              }
              speedAuditData={
                section.id === "speed-heuristics"
                  ? backendData.speed_audit
                  : null
              }
              sitemapData={
                section.id === "sitemap-validator" ? backendData.sitemap : null
              }
              linkAuditData={
                section.id === "link-audit" ? backendData.link_audit : null
              }
              onOpenBrokenLinksModal={
                section.id === "link-audit" ? handleOpenBrokenLinksModal : null
              }
              ogTwitterData={
                section.id === "social-meta-preview"
                  ? backendData.og_twitter_audit
                  : null
              }
              mobileResponsivenessData={
                section.id === "mobile-responsiveness-audit"
                  ? backendData.mobile_responsiveness_audit
                  : null
              }
              onOpenFixedWidthElementsModal={
                section.id === "mobile-responsiveness-audit"
                  ? handleOpenFixedWidthElementsModal
                  : null
              }
              onOpenResponsivenessIssuesModal={
                section.id === "mobile-responsiveness-audit"
                  ? handleOpenResponsivenessIssuesModal
                  : null
              }
              structuredDataAuditData={
                section.id === "structured-data-schema"
                  ? backendData.structured_data_audit
                  : null
              }
              localSeoAuditData={
                section.id === "local-seo-audit"
                  ? backendData.local_seo_audit
                  : null
              }
